          ...
          <Row>
              ...
              <div className="comment__list mt-5">
                ...
                <div className="single__comment d-flex gap-3">
                  ...
                  <div className="comment__content">
                    <h6 className=" fw-bold">Олег Майами</h6>
                    <p className="section__description mb-0">14 July, 2025</p>
                    <p className="section__description">
                      Ну дела, детали блога
                    </p>

                    <span className="replay d-flex align-items-center gap-1">
                      <i class="ri-reply-line"></i> Повторить
                    </span>
                  </div>
                </div>
                ...
                <div className="leave__comment-form mt-5">
                  ...
                  <p className="section__description">
                    Вы должны авторизироваться чтобы оставить комментарий на пост
                  </p>
            ...
            <Col lg="4" md="4">
              <div className="recent__post mb-4">
                <h5 className=" fw-bold">Последний пост</h5>
              </div>
              {blogData.map((item) => (
